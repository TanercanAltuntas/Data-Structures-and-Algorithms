...
public class SequentialSearchST<Key, Value> {
	...
	private Node first_head; // the linked list of key-value pairs
	...
	public Value get(Key key) {
		...
		// Postcondition: There is no postcondition.
		// --------------------------------------------------------
		for (Node x = first_head; x != null; x = x.next) {
			if (key.equals(x.key))
				return x.val;
		}
		return null;
	...
	public void put(Key key, Value val) {
		...
		first_head = new Node(key, val, first_head);
		n++;
	}

	public ArrayList<Key> Key_find() {
		// --------------------------------------------------------
		...
		for (Node i = first_head; i != null; i = i.next) {
			if (i.key != null) {
				value.add(i.key);
			}
		}
	...
	public void delete(Key key) {
		...
		// Postcondition: There is no postcondition.
		// --------------------------------------------------------
		first_head = delete(first_head, key);
	}
